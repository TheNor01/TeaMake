...
public class RidesActivity extends AppCompatActivity {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                if(task.getResult().isEmpty()){
                                    RideItem MI = new RideItem("dummy", R.drawable.baseline_school_24, "dummy", "2023/04/02", "00:00", -1, R.drawable.baseline_notifications_24);
                                    ridesList.add(MI);
                                }
    ...
    protected RideItem CreateRide(QueryDocumentSnapshot document){
        ...
        return new RideItem(document.getId(), R.drawable.baseline_school_24, destinationUniversity, date, time, locationInfo, R.drawable.baseline_info_24);
